...
class FindLocation(object):
	...
	def find_position(self):
		...
		the_ip_info = ['所在维度：' + str(latitude), '所在经度：' + str(longitude), "地域代号：" + str(region_code), "所在城市：" + str(city), "所在国家或地区：" + str(country), "需要查询的IP：" + str(self.ip_addr)]
